...
class NotChosen extends Component {
    constructor(props) {
        super(props);
        console.log('moroo');
    ...
    render() {
        ...
        var relations = this.state.relations.filter(addToList => {return addToList.choice==='0' && addToList.user.uid===this.props.user}).map(function (choice) {
